...
| [[concepts/lifelog2-signal-statistics-roadmap\|lifelog2-signal-statistics-roadmap]] | **Roadmap Segnali — Fase 0 ✅ IMPLEMENTATA 2026-07-18** — signal_class deterministico (badge+filtro in grid), weekly_metrics (card Profile). Fase 1 (LLM promote-only, evidence recency) e Fase 2 (Z5 narrativo) ancora da fare. |
